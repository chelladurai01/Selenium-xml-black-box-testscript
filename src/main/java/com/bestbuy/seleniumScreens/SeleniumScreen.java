...
import com.bestbuy.seleniumScreens.constants.GetCurrentDir;
...
public class SeleniumScreen {
	...
	protected LaunchApplication launchApp;
	...
	public SeleniumScreen(String browserName, String platform, String url,
			String resolution) {
	...
	public void waitForElementPresent(String locator, String methodName,
		...
		try {
			...
			waitForSeconds(Constants.ONE_THOUSAND_SECONDS);
	 ...
	 *            Time to wait
	 */
	public void waitForSeconds(long value) {
		try {
			Thread.sleep(value);
	...
	public void windowResize(String resolution) {
